...
module PrivateParlorXT
  ...
  abstract class History
    ...
    abstract def origin_message(message : MessageID) : MessageID?
    ...
    abstract def receiver_message(message : MessageID, receiver : UserID) : MessageID?

    # Get the sender of the original message referenced by the given message ID
    abstract def sender(message : MessageID) : UserID?
    ...
    abstract def warned?(message : MessageID) : Bool?
