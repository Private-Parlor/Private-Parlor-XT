...
module PrivateParlorXT
  class MessageQueue
    ...
    # TODO: Rename to differentiate from the other add_to_queue functions
    def add_to_queue(receiver : Int64, receiver_message : ReplyParameters?, func : MessageProc) : Nil
      @queue_mutex.synchronize do
