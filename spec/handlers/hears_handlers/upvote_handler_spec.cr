  ...
  describe UpvoteHandler do
    ...
    describe "#is_authorized?" do
      it "returns true if user can upvote" do
        ...
        handler.is_authorized?(beispiel, message, :Upvote, services).should(be_true)
      end
      ...
      it "returns false if user can't upvote" do
        ...
        handler.is_authorized?(unauthorized_user, message, :Upvote, services).should(be_false)
      end
    end
    ...
    describe "#is_spamming?" do
      it "returns true if user is upvote spamming" do
        ...
        unless expiration_time = spam.upvote_last_used[beispiel.id]?
