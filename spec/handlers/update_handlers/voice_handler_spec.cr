  ...
  describe VoiceHandler do
    ...
    describe "#do" do
      it "returns early if message is a forward" do
        ...
        handler = VoiceHandler.new(MockConfig.new)
      ...
      it "returns early if message has no voice media" do
        services = create_services(ranks: ranks, relay: MockRelay.new("", MockClient.new))
      ...
      it "returns early with 'unoriginal message' response if Robot9000 is enabled and message is not unique" do
        ...
        messages.size.should(eq(4))
        messages[0].data.should(eq("voice_item_one"))
      ...
      it "records message statistics when statitics is enabled" do
        ...
        result[Statistics::MessageCounts::Voice].should(eq(1))
      ...
      it "queues voice message" do
        ...
        messages.each do |msg|
          ...
          msg.data.should(eq("voice_item_one"))
      ...
      it "queues voice message with reply" do
        services = create_services(ranks: ranks, relay: MockRelay.new("", MockClient.new))
    ...
    describe "#spamming?" do
      ...
      it "returns false if there is no spam handler" do
        services = create_services(ranks: ranks)
    ...
    describe "#has_sufficient_karma?" do
      ...
      it "returns true if price for voice messages is less than 0" do
        services = create_services(karma_economy: KarmaHandler.new(karma_voice: -10))
    ...
    describe "#spend_karma" do
      ...
      it "returns unaltered user if price of voice messages is less than 0" do
        services = create_services(karma_economy: KarmaHandler.new(karma_voice: -10))
