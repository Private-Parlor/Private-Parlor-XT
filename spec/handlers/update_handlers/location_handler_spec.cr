...
module PrivateParlorXT
  describe LocationHandler do
    ...
    describe "#do" do
      it "returns early if message is a forward" do
        ...
        message = create_message(
          ...
          location: Tourmaline::Location.new(0.0, 0.0),
      ...
      it "returns early if message has no location" do
        services = create_services(ranks: ranks, relay: MockRelay.new("", MockClient.new))
      ...
      it "records message statistics when statitics is enabled" do
        ...
        result[Statistics::MessageCounts::Locations].should(eq(1))
      ...
      it "queues location message with reply" do
        services = create_services(ranks: ranks, relay: MockRelay.new("", MockClient.new))
    ...
    describe "#spamming?" do
      it "returns true if user is spamming locations" do
        ...
        spam_services = create_services(
          spam: SpamHandler.new(spam_limit: 10, score_location: 6)
        )
    ...
    describe "#has_sufficient_karma?" do
      ...
      it "returns true if price for location messages is less than 0" do
        services = create_services(karma_economy: KarmaHandler.new(karma_location: -10))
    ...
    describe "#spend_karma" do
      ...
      it "returns unaltered user if price of location messages is less than 0" do
        services = create_services(karma_economy: KarmaHandler.new(karma_location: -10))
