...
module PrivateParlorXT
  describe VideoHandler do
    ...
    describe "#do" do
      ...
      it "returns early if message has no video media" do
        services = create_services(ranks: ranks, relay: MockRelay.new("", MockClient.new))
      ...
      it "returns early with 'unoriginal message' response if Robot9000 is enabled and message is not unique" do
        ...
        messages.size.should(eq(4))
        messages[0].data.should(eq("video_item_one"))
      ...
      it "records message statistics when statitics is enabled" do
        ...
        result[Statistics::MessageCounts::Videos].should(eq(1))
    ...
    describe "#has_sufficient_karma?" do
      ...
      it "returns true if price for video messages is less than 0" do
        services = create_services(karma_economy: KarmaHandler.new(karma_video: -10))
    ...
    describe "#spend_karma" do
      ...
      it "returns unaltered user if price of video messages is less than 0" do
        services = create_services(karma_economy: KarmaHandler.new(karma_video: -10))
